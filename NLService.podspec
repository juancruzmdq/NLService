...
Pod::Spec.new do |s|
  s.name             = 'NLService'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NLService.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/NLService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Juan Cruz Ghigliani' => 'juancruzmdq@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/NLService.git', :tag => s.version.to_s }
